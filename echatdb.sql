...
(1, 'Anand', 'admin', 'Sherikar', 'Admin Anand'),
(2, 'Swarup', 'naruto', 'Ravuri', 'Tejswarup'),
(3, 'Ravi', 'uzumaki', 'Thiparthi', 'Ravi Teja'),
(9, 'Raju', 'raju', 'Pothnak', 'Pruthviraj'),
(11, 'Nagarjuna', 'katraj', 'Paladugu', 'Nagarjuna');
