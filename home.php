...
<html>
<head>
	<title>Chatting application- 2021</title>
...
<center>
	<div id="main">
		<h1>
			<font style="color:red; font-family:Calibri;">Online </font>Chat<hr>
		</h1>
		<table width="100%" style="background:">
			<tr>
				...
				<td align="right">
					<a href="logout.php"><div id="lo-but"><p style="font-family:Comic Sans Ms; font-size:18px;">Logout</p></div></a>
				</td>
			</tr>
		</table>
...
body
{
	background: url(Chatimages/home.jpg);
	color:white;
